...
run-unique-ids: gleipnir
	@echo "+ $@"
	@docker run --rm -it -p 20000:8080 ${IMAGE_NAME}:${VERSION} test -w unique-ids --bin /app/gleipnir-unique-ids --time-limit 30 --rate 1000 --node-count 3 --availability total --nemesis partition
